...
struct b2BodyDef
{
	...
	void setPosition(float32 x, float32 y) {position = b2Vec2(x, y);}
...
class b2Body : public JacosBaseObject
{
public:
...
inline void b2Body::SetUserData(v8::Handle<v8::Value> data)
{
	if (!m_jsUserData.IsEmpty())
		m_jsUserData.Dispose();
...
inline v8::Handle<v8::Value> b2Body::GetJSUserData() const
{
    return m_jsUserData;
}
