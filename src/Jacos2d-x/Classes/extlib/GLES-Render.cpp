...
static GLESDebugDraw *defaultDebugDraw = NULL;
const GLESDebugDraw* getDefaultDebugDraw()
{
	if (defaultDebugDraw == NULL)
		defaultDebugDraw = new GLESDebugDraw();
	return defaultDebugDraw;
}
